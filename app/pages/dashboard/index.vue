  ...
  <div class="flex-1 flex">
    <div class="bg-base-100 transition-all duration-300" :class="{ 'w-64': isSidebarOpen, 'w-16': !isSidebarOpen }">
      ...
      <div class="flex flex-col">
        <SidebarButton :show-label="isSidebarOpen" href="/locations" label="Locations" icon="tabler:map" />
        <SidebarButton :show-label="isSidebarOpen" href="/add" label="Add Location" icon="tabler:location-plus" />

        <div class="divider" />

        <SidebarButton :show-label="isSidebarOpen" href="/sign-out" label="Sign Out" icon="tabler:logout-2" />
      </div>
    </div>
    <div class="flex-1" />
  </div>
